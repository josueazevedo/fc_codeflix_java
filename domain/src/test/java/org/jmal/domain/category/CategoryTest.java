package org.jmal.domain.category;

import org.jmal.domain.category.Category;
import org.jmal.domain.exceptions.DomainException;
import org.jmal.domain.validation.handler.ThrowsValidationHandler;
...
public class CategoryTest {
    ...
    public void givenAValidDeactivateCategory_whenCallActivate_thenReturnCategoryActivated() {
        ...
        Assertions.assertTrue(aCategory.getUpdatedAt().isAfter(updateAt));
